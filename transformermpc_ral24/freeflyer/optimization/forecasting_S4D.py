...
if __name__ =='__main__':
    ...
    model_S4 = DMS4_manager.get_S4_model(ssm_model_name, train_loader, eval_loader)
    ...
    for idx, test_sample in enumerate(test_loader):
        ...
        inference_func_S4 = getattr(DMS4_manager, 'ssm_model_inference_'+transformer_ws+'_T')  #ssm_model_inference_dyn_T
        ...
        p4 = ax.plot(states_ws_S4[0,:], states_ws_S4[1,:], color='darkgreen', linewidth=1.5, label='warm-start S4-' + transformer_ws, zorder=3)
        ...
        if states_scp_S4 is not None:
            p6 = ax.plot(states_scp_S4[0,:], states_scp_S4[1,:], color='violet', linewidth=1.5, label='scp-S4-' + transformer_ws, zorder=3)
        ...
        plt.savefig(f"{root_folder}/optimization/saved_files/prediction_analysisS4FULL/plots/pos_3d_{idx}.png" )
        ...
        if idx % 100 == 0:
            ''' Save results '''
            np.savez_compressed(root_folder + '/optimization/saved_files/prediction_analysisS4FULL/pred_analysis_2_' + transformer_model_name + '_vs_' + ssm_model_name + '_test'+str(idx),
                    # Feasibility flags
    ...
    ''' Save results '''
    np.savez_compressed(root_folder + '/optimization/saved_files/prediction_analysisS4FULL/pred_analysis_2_' + transformer_model_name + '_vs_' + ssm_model_name + '_test',
    ...
    # np.savez_compressed(root_folder + '/optimization/saved_files/prediction_analysisS4/pred_analysis_' + transformer_model_name + '_vs_' + ssm_model_name + '_test',
    #                 runtime_list_CVX = runtime_list_CVX,
    #                 trajectory_rmse_list_DT = trajectory_rmse_list_DT,
    #                 control_error_list_DT = control_error_list_DT,
    #                 final_state_error_list_DT = final_state_error_list_DT,
