...
#S4 Modules
from SSM.models import TrajectoryFFS4FULLModel
...
# Initial parameters
model_name_saving = 'checkpoint_ff_S4_rcgsa'  # 
save_path = '/s4/saved_files/checkpointsfull/'
mdp_constr = True
...
model = TrajectoryFFS4FULLModel(state_dim = n_state,
                            act_dim = n_action,
                            d_model=350,       # 128: S4
                            n_layers=6,
                            max_ep_len=100,
