...
#S4 Modules
from SSM.models import TrajectoryFFS4DModel
...
save_path = '/s4/saved_files/checkpointsscp384long/'
mdp_constr = True
...
model = TrajectoryFFS4DModel(state_dim = n_state,
                            act_dim = n_action,
                            d_model=278,       # 240 modelsscp[S4], 278 S4D - modelscp384
                            n_layers=6,
                            max_ep_len=350,
                            dropout=0.2,
                            prenorm=False,       
