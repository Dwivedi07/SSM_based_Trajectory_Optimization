...
transformer_model_name =  'checkpoint_ff_GSA'  #'checkpoint_ff_ctgrtg_art' #'checkpoint_rtn_v11'/'checkpoint_rtn_v01'
...
idx = 7195 #22260 # index of the test trajectory 19030, 11787, 5514->infeasible in cvxMPC at 4 timestep 32172
