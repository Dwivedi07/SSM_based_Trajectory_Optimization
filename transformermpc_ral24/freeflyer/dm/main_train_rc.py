...
# Initial parameters
model_name_saving = 'checkpoint_ff_S6_rcgsa'  # 'checkpoint_ff_S6_gsa' , 'checkpoint_ff_S6_grcsa'
save_path = '/dm/saved_files/checkpointsrcgsa/'
mdp_constr = True

'''
Load the data for training(from decision transformer set up particularly for r,c,g,s,a setup)
'''
...
model = Mamba_Traj(
        state_dim=6,                 # state dimension in real dyanmics
        act_dim=3,                   # action dimension in real dynamics
