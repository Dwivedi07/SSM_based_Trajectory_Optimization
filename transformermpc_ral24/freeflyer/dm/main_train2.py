...
# SSM modules
from mamba.S6modelffDM import Mamba_Traj
...
# Initial parameters
model_name_saving = 'checkpoint_ff_S6_gsa'  # 'checkpoint_ff_S6_gsa' , 'checkpoint_ff_S6_grcsa'
save_path = '/dm/saved_files/checkpointsscp3/'
mdp_constr = True
...
print(model)
model.to(device);
optimizer = AdamW(model.parameters(), lr=3e-5)   # lr = 3e-5 
