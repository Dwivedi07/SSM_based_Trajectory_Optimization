...
config = MambaConfig(
    ...
    d_model=512,     # Hidden dimension size 384/250/240
    ...
    d_state=16,     # State size for Mamba - Maximum is 256
        ...
        if step>= 50000:     #100000
            ...
            with accelerator.accumulate(model):
                ...
                if (step % eval_steps*10) == 0:
                    accelerator.save_state(root_folder + '/mamba/saved_files/checkpoints_S63_l6_d16_dm512/checkpoint_rtn_s6_train')
...
plt.legend()
plt.grid(True)
plt.savefig(root_folder + '/mamba/saved_files/checkpoints_S63_l6_d16_dm512/trainloss.png')
plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig(root_folder + '/mamba/saved_files/checkpoints_S63_l6_d16_dm512/evalloss.png')
plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig(root_folder + '/mamba/saved_files/checkpoints_S63_l6_d16_dm512/evalstateloss.png')
plt.show()
...
plt.legend()
plt.grid(True)
plt.savefig(root_folder + '/mamba/saved_files/checkpoints_S63_l6_d16_dm512/evalactionloss.png')
plt.show()

# Saving the data in a csv file

file_name = "checkpoints_S63_l6_d16_dm512_losses_data.csv"
